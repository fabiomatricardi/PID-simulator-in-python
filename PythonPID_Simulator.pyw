...
class PID_Simulator(object):
    ...
    def __init__(self):
        ...
        self.left_frame = ttk.LabelFrame(self.master_frame, text=" Controller ")
        self.left_frame.pack(side="left", fill="both", expand=True, padx=10, pady=10)
        self.middle_frame = ttk.LabelFrame(self.master_frame, text=" Result ")
        self.middle_frame.pack(side="left", fill="both", expand=True, padx=10, pady=10)
        self.right_frame = ttk.LabelFrame(self.master_frame, text=" Process ")
        ...
        # Button
        button_refresh = ttk.Button(self.left_frame, text="Refresh", command=self.generate_response)
